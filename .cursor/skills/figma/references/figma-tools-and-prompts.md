...
- Change framework: "generate my Figma selection in Astro + React" or "in plain HTML + CSS" or "for iOS".
- Use my components: "generate my Figma selection using components from `src/components` and `src/registry`".
- Combine: "generate my Figma selection for Astro pages with React islands and plain CSS".
...
- "map this node to `src/components/App.jsx` with name `App`"
